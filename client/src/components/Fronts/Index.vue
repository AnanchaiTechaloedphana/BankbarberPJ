<template>
  <div>
    ...
    <div class="hero-wrapper">
      ...
      <h3>Manipulator</h3>
      <p>
        <i class="fas fa-user-circle"></i> Ananchai Techaloedphana &nbsp;&nbsp;<i
          class="fas fa-envelope"
        ></i>
        <a href="mailto:ananchait62@nu.ac.th" style="color: #000000"
          >ananchait62@nu.ac.th</a
        ><br />
        <i class="fas fa-user-circle"></i> Sapphaya Panalai &nbsp;&nbsp;<i
          class="fas fa-envelope"
        ></i>
        <a href="mailto:sapphayap62@nu.ac.th" style="color: #000000"
          >sapphayap62@nu.ac.th</a
        >
      </p>
    </div>
    <br />
